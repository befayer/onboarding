package com.company.onboarding.screen.myonboardingsrceen;
...
@UiController("MyOnboardingSrceen")
@UiDescriptor("my-onboarding-srceen.xml")
public class MyOnboardingSrceen extends Screen {
    @Autowired
